...
class Gallery:
    ...
    def update_authors_info(self):
        for author, info in list(self.authors.items()):
            ...
            authors2tsv(self.authors, self.content_dir)
        self.save()
